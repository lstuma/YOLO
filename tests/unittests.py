...
class TestStringMethods(unittest.TestCase):
    ...
    def test_iou(self):
        ...
        print("[Test] Testing IoU calculation")
        ...
        if outcome != 0: self.fail("Case 4: Failed due to unexpected outcome")
        ...
        if outcome != 0.5: self.fail("Case 4: Failed due to unexpected outcome")
